...
import { Camera, Search, Menu, Plus, Trash2, X, History, Clock, Trash, ToggleLeft, ToggleRight, Video, ChevronDown, ChevronUp, Settings, Minus, Home, Compass, Library, Upload, Clock3, Star, Bookmark, Tag, Users, FolderOpen } from 'lucide-react';
        ...
        <div className="w-full max-w-[2000px] mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-lg md:text-xl font-bold text-primary">Twisted Brody FlowHub</span>
            </Link>
          </div>
